...
class RecurrentQNetwork(tf.keras.Model):
    def __init__(self, action_space):
        ...
        self.input_layer = kl.Dense(128, activation='relu', kernel_initializer='he_normal')
        self.lstm = kl.LSTMCell(128)
        self.output_layer = kl.Dense(action_space, kernel_initializer='he_normal')
...
if __name__ == "__main__":
    ...
    for i in range(999):
        action, (c, h) = recurrent_qnet.sample_action(state, c, h, prev_action, epsilon)
